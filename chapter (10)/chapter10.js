...
function replaceIt() {
    ...
    var theStory = "<h1>james Dance Party</h1>";
    theStory += "One " + adj1 + " day, james was " + verbIng + " in his " + roomInHouse + ", reading a book about " + color + " " + nounPlural + ".<br><br>";
    ...
    theStory += "james danced the " + animal + " Dance, the " + city + " Shake, and took the prize for dancing the best Electric " + verb + ".<br><br>";
